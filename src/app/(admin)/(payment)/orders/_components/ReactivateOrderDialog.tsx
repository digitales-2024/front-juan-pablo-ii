...
interface ReactivateOrderDialogProps extends ComponentPropsWithoutRef<typeof AlertDialog> {
  order?: Order;
  orders?: Order[];
  showTrigger?: boolean;
  onSuccess?: () => void;
...
export function ReactivateOrderDialog({
  order,
  orders,
  showTrigger = true,
  onSuccess,
  ...props
}: ReactivateOrderDialogProps) {
  const isDesktop = useMediaQuery("(min-width: 640px)");
  const { reactivateMutation: { isPending, mutateAsync } } = useOrders();
