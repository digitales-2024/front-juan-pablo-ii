...
export function ConfirmOrderDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Confirmar procesar orden</DialogTitle>
                    <DialogDescription>
                        ¿Está seguro que desea procesar esta orden? Una vez procesada no podrá retroceder, a menos que rechace la ordén antes de verificar.
                    </DialogDescription>
                </DialogHeader>
