...
export function ConfirmOrderDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Confirmar verificaciòn de pago</DialogTitle>
                    <DialogDescription>
                        ¿Está seguro que desea verificar el pago? Una vez verificado no podrá retroceder, y se generará una salida.
                    </DialogDescription>
                </DialogHeader>
