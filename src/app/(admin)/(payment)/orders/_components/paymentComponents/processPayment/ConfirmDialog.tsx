...
export function ConfirmOrderDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Confirmar procesar pago</DialogTitle>
                    <DialogDescription>
                        ¿Está seguro que desea procesar el pago de esta orden? Una vez procesada no podrá retroceder, a menos que rechace la ordén antes de verificar.
                    </DialogDescription>
                </DialogHeader>
