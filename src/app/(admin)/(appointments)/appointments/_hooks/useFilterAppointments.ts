...
export const useFilterAppointments = () => {
    ...
    const setFilterByStatus = useCallback((status: AppointmentStatus) => {
        ...
        // IMPORTANTE: Eliminar TODAS las consultas relacionadas con citas paginadas
        ...
        // Forzar una revalidación INMEDIATA para obtener los datos filtrados
        setTimeout(() => {
            console.log('⚡ Forzando obtención de datos inmediata para el nuevo filtro:', status);
            queryClient.refetchQueries({
                queryKey: newQueryKey,
                exact: true,
                refetchType: 'all'  // Usar 'all' en lugar de 'active' para forzar la actualización
            });
