  ...
  return (
    ...
    <Popover {...rest}>
      ...
      <PopoverContent>
        <Card>
            <CardHeader>
                <CardTitle>Almacén de Origen</CardTitle>
                <CardDescription>Detalles del almacén de origen.</CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
                    <TableBody>
                        ...
                        <TableRow>
                            ...
                            <TableCell>{oneStorageQuery.data[0].TypeStorage.name}</TableCell>
                        </TableRow>
                        {/* <TableRow>
