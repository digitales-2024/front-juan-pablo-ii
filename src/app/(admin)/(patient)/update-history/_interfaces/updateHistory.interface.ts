...
export type UpdateHistoryResponsePrototype =
  components["schemas"]["UpdateHistoryResponse"];
export type UpdateHistoryDataPrototype =
  components["schemas"]["UpdateHistoryData"];
export type UpdateHistoryImagePrototype =
  components["schemas"]["UpdateHistoryImage"];
...
//inicio de retipado
export type UpdateMedicalHistoryDtoPrototype =
  components["schemas"]["UpdateMedicalHistoryDto"];
//retipamos el campo medicalHistory para que sea un objeto
export type UpdateMedicalHistoryDto = Omit<
  UpdateMedicalHistoryDtoPrototype,
  "medicalHistory"
...
export type UpdateHistoryResponseImage = UpdateHistory & {
  images?: MeidicalHistoryImage[];
};
...
export type CreateUpdateHistoryDto =
  components["schemas"]["CreateUpdateHistoryDto"];
export interface CreateUpdateHistoryFormData {
  data: CreateUpdateHistoryDto;
  image?: File[] | null;
}

export type UpdateUpdateHistoryDto =
  components["schemas"]["UpdateUpdateHistoryDto"];

export type UpUpdateHistoryDto = {
  patientId?: string;
  serviceId?: string;
  staffId?: string;
  branchId?: string;
  medicalHistoryId?: string;
  updateHistory?: {randomId: string;};
};

//fin
export interface UpdateUpdateHistoryFormData {
  data: UpUpdateHistoryDto;
  newImages?: File[] | null;
}
...
export type PrescriptionItemPrototype =
  components["schemas"]["PrescriptionItemResponse"];
...
export type CreatePrescriptionDtoPrototype =
  components["schemas"]["CreatePrescriptionDto"];

export type PrescriptionItemDtoPrototype =
  components["schemas"]["PrescriptionItemDto"];
...
export type UpdatePrescriptionDtoPrototype =
  components["schemas"]["UpdatePrescriptionDto"];
...
export type DeletePrescriptionDto =
  components["schemas"]["DeletePrescriptionDto"];
