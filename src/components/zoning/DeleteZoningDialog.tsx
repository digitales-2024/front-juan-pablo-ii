...
interface DeleteZoningDialogProps
...
export function DeleteZoningDialog({
    zoning,
    showTrigger = true,
    onSuccess,
    ...props
}: DeleteZoningDialogProps) {
    const [isDeletePending] = useTransition();
    const isDesktop = useMediaQuery("(min-width: 640px)");

    const { onDeleteZoning } = useZoning();

    const onDeleteZoningHandler = () => {
        onDeleteZoning(zoning);
