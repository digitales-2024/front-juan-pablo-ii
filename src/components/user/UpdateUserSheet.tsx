...
export function UpdateUserSheet({ user }: UpdateUserSheetProps) {
  ...
  }, [isSuccessUpdateUser, form, router]);

  return (
    <>
      <Button variant="ghost" onClick={() => setIsSheetOpen(true)} size="icon" aria-label="Actualizar Usuario">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4 p-2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="john smith" className="resize-none" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="985523221" className="resize-none" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <SheetFooter className="gap-2 pt-2 sm:space-x-0">
                  <div className="flex flex-row-reverse flex-wrap gap-2">
                    <Button type="submit" disabled={isLoadingUpdateUser}>
                      {isLoadingUpdateUser && (
